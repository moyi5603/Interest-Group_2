  ...
  return (
    <div className="mx-auto flex h-screen max-w-md flex-col bg-background">
      ...
      <main className="flex-1 space-y-4 overflow-y-auto px-3 pb-24 scrollbar-hide">
        <p className="rounded-2xl bg-amber-50 px-3 py-2 text-xs text-amber-900 dark:bg-amber-950/40 dark:text-amber-100">
          创建后立即上线；请在 7 日内向工会/HR 完成报备。
        </p>
