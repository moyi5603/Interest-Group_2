...
(function () {
  ...
  const notifications = [
    { id: 'n1', kind: 'published', gid: 'g1', aid: 'a1', linkTo: 'activity', read: false, time: '刚刚',
      text: '「城市夜跑团」发布了新活动「滨江 8K 夜跑 · 江风配速团」，快来看看' },
    { id: 'n2', kind: 'signup', gid: 'g1', aid: 'a1', linkTo: null, read: false, time: '5 分钟前',
      text: '许墨 报名了「滨江 8K 夜跑 · 江风配速团」，当前共 27 人报名' },
    { id: 'n3', kind: 'join', gid: 'g1', linkTo: null, read: false, time: '32 分钟前',
      text: '邵阳 加入了「城市夜跑团」' },
    { id: 'n4', kind: 'join_request', gid: 'g6', linkTo: null, read: false, time: '1 小时前',
      text: '安然 申请加入「职场成长营」，请到管理后台进行审核' },
    { id: 'n5', kind: 'join_result', gid: 'g3', linkTo: 'group', approved: true, read: false, time: '2 小时前',
      text: '你的「深夜读书会」加入申请已通过' },
    { id: 'n6', kind: 'join_result', gid: 'g6', linkTo: 'group', approved: false, read: true, time: '3 小时前',
      text: '你的「职场成长营」加入申请未通过' },
    { id: 'n7', kind: 'terminate', aid: 'a10', linkTo: null, read: false, time: '昨天 18:20',
      text: '「周一晚共读 · 固定围读局」已终止，报名已作废' },
    { id: 'n8', kind: 'disband', gid: 'g9', linkTo: null, read: true, time: '昨天 15:00',
      text: '「视觉设计交流组」已解散，感谢你的参与' },
    { id: 'n9', kind: 'starting_1h', aid: 'a3', linkTo: 'activity', read: false, time: '今天 11:30',
      text: '「午休快开一局 · 阿瓦隆」将在 1 小时后开始，记得准时到场' },
    { id: 'n10', kind: 'starting_1d', aid: 'a1', linkTo: 'activity', read: false, time: '昨天 19:30',
      text: '你报名的「滨江 8K 夜跑 · 江风配速团」明天 19:30 开始，记得准时到场' },
    { id: 'n11', kind: 'ended', aid: 'a1', linkTo: 'activity', read: true, time: '5/29 22:10',
      text: '「滨江 8K 夜跑 · 江风配速团」已结束，欢迎留言或发精彩瞬间' },
    { id: 'n12', kind: 'cancel', gid: 'g2', aid: 'a2', linkTo: null, read: true, time: '5/28 14:20',
      text: '罗茜 取消了「云栖谷溪行 · 看日出系列 ②」的报名' },
    { id: 'n13', kind: 'comment_reply', aid: 'a1', linkTo: 'activity', read: true, time: '5/27 20:45',
      text: '许墨 回复了你:跑后撸串记得叫我，我请奶茶' },
  ];
  ...
  const convos = [
    ...
    { id: 'cv1', kind: 'notify', name: '沟通引擎', seed: 'engine', time: '刚刚', unread: 8, pinned: true, official: true,
      prefix: '[新活动]', preview: '「城市夜跑团」发布了新活动「滨江 8K 夜跑 · 江风配速团」，快来看看' },
